...
// Desktop edit page for a Proposal. Renders a single AutoForm generated from
// the backend describe() catalog. No JSX is hardcoded per field. Conventions
// UI épurées strictes (cf .claude/CLAUDE.md): pas de shadow-sm, pas de
// rounded-2xl, density tight, pas de transition-all.
export const ProposalEditPageDesktop = ({
    isNew,
    proposal,
    setProposal,
    loading,
                    ...
                    {loading ? (
                        ...
                        <AutoForm
                            ...
                            excludeKeys={[
                                ...
                                "lastMainDoc",
                                "modelPdf",
                                // Author / closer are auto-resolved by Dolibarr
                                "fkUserAuthor",
                                "fkUserValid",
                                "fkUserCloture",
                            ]}
                        ...
                        {/* Lines editor: only after the proposal exists in DB.
                            On creation the user first saves the header (which
                            redirects to /proposals/:id/edit), then the editor
                        ...
                        <DocumentLinesEditor
                            ...
                            onChange={(updatedDoc) => {
                                if (typeof setProposal === "function" && updatedDoc) {
                                    setProposal(updatedDoc);
                                }
                            }}
                        />
                        </div>
