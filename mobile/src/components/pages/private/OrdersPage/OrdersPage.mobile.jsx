...
// Status labels from Dolibarr Commande::STATUS_*
const STATUS_LABELS = {
    [-1]: "Annulé",
    0: "Brouillon",
    1: "Validé",
...
// Mobile rendering of the orders list. Presentational only.
export const OrdersPageMobile = (props) => {
    const {
        navigate,
    ...
    const goToOrder = (id) => navigate(`/orders/${id}`);
    ...
    return (
        <Page contentProps={{ className: "pb-app-base md:pb-6" }}>
            <div className="flex items-center gap-app-sm px-app-base pt-app-base md:px-6 md:max-w-5xl md:mx-auto">
                ...
                <h1 className="text-app-2xl font-bold flex-1">Commandes</h1>
                <Button
                    onClick={goNew}
                    icon={FaPlus}
