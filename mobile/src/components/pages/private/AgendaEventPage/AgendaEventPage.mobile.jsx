...
// Mobile rendering of the agenda event detail page. Historical implementation
// extracted verbatim from the legacy AgendaEventPage/index.jsx; only the data
// loading + handlers were lifted into useAgendaEventData (single source of
// truth shared with the desktop variant). Cf .claude/CLAUDE.md "Architecture
// viewport-aware".
export const AgendaEventPageMobile = (props) => {
    const {
