...
import { supplierProposalsListConfig } from "./listConfig";

// Desktop layout for the supplier price requests (SupplierProposal) list.
export const SupplierProposalsPageDesktop = (props) => {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-white overflow-hidden">
            ...
            <div className="flex-1 min-h-0 overflow-hidden">
                <DataTable
                    config={supplierProposalsListConfig}
                    dataSource={dataSource}
                    feature="supplierproposals"
