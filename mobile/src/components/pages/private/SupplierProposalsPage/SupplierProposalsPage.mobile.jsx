...
// Mobile rendering of the supplier price requests list. Presentational only.
export const SupplierProposalsPageMobile = (props) => {
    const {
        navigate,
    ...
    const goTo = (id) => navigate(`/supplier-proposals/${id}`);
    const goNew = () => navigate("/supplier-proposals/new");
    ...
    return (
        <Page contentProps={{ className: "pb-app-base md:pb-6" }}>
            <div className="flex items-center gap-app-sm px-app-base pt-app-base md:px-6 md:max-w-5xl md:mx-auto">
                ...
                <h1 className="text-app-2xl font-bold flex-1">Demandes de prix</h1>
                <Button
                    onClick={goNew}
                    icon={FaPlus}
                ...
                <div className="flex flex-col gap-app-sm md:flex-row md:items-end md:gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        >
                            ...
                            <option value="3">Non signée</option>
            ...
            <div className="px-app-base mt-app-base flex flex-col gap-app-sm md:px-6 md:max-w-5xl md:mx-auto">
                ...
                {!loading && !error && items?.length === 0 && (
                    <div className="text-center text-gray-500 p-4">Aucune demande de prix</div>
                )}
                {!loading && !error && items?.map((r) => (
                    ...
                    >
                        ...
                        <div className="text-sm text-gray-600 flex justify-between mt-1">
                            <span>{r.socid ? `Fournisseur #${r.socid}` : ""}</span>
