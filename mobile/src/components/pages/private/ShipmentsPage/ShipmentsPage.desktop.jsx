...
import { shipmentsListConfig } from "./listConfig";

// Desktop layout for the shipments (Expedition) list.
export const ShipmentsPageDesktop = (props) => {
