...
// Desktop edit page for an Order. Renders a single AutoForm generated from
...
export const OrderEditPageDesktop = ({
    isNew,
    order,
    setOrder,
    loading,
                    ...
                    {loading ? (
                        ...
                        <AutoForm
                            ...
                            excludeKeys={[
                                ...
                                "modelPdf",
                                "facturee",
                                // Author / closer / modifier are auto-resolved by Dolibarr
                                "fkUserAuthor",
                                "fkUserValid",
                                "fkUserCloture",
                                "fkUserModif",
                        ...
                        {/* Lines editor: only after the order exists in DB.
                            On creation the user first saves the header (which
                            redirects to /orders/:id/edit), then the editor
