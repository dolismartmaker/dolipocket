...
import { productsListConfig } from "./listConfig";

// Desktop layout for the products list. Plain flex container that fills
// the available space inside the AppShell main area, with internal scroll
// delegated to the DataTable.
export const ProductsPageDesktop = (props) => {
