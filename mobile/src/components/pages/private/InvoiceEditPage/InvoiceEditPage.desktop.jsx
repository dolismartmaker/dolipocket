...
// Desktop edit page for an Invoice. Renders a single AutoForm generated from
            ...
            <div className="flex-1 overflow-auto">
                <div className="max-w-[1200px] mx-auto px-6 py-6">
                    ...
                    {loading ? (
                        ...
                        {/* Lines editor: only after the invoice exists in DB.
                            On creation the user first saves the header (which
                            redirects to /invoices/:id/edit), then the editor
