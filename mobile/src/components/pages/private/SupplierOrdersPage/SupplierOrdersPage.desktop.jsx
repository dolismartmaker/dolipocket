...
import { supplierOrdersListConfig } from "./listConfig";

// Desktop layout for the supplier orders (CommandeFournisseur) list.
export const SupplierOrdersPageDesktop = (props) => {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-white overflow-hidden">
            ...
            <div className="flex-1 min-h-0 overflow-hidden">
                <DataTable
                    config={supplierOrdersListConfig}
