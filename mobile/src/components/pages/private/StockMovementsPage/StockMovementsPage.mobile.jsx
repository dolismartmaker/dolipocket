...
// Mobile stock movements history: gradient header, filters card, vertical list
// of movement cards. Presentational only -- state + handlers come from
// useStockMovementsData() (cf .claude/CLAUDE.md viewport-aware pattern).
export const StockMovementsPageMobile = (props) => {
    const {
        movements,
        products,
        warehouses,
            ...
            <div className="bg-gradient-to-r from-primary to-secondary p-4 text-white">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-white/80">{movements?.length ?? 0} mouvements</p>
                    </div>
                </div>
            </div>
            ...
            <div className="p-4 flex flex-col gap-3">
                <div className="bg-white rounded-lg border border-gray-200 p-3 flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium text-gray-600">Entrepôt</label>
                            <select
...
export default StockMovementsPageMobile;
