...
import { stripRecoveryParam } from "./lib/recovery/swRecovery";
...
// Remove the one-shot cache-busting param left by a previous SW recovery, so
// the URL stays clean after the boundary reloaded the app on a fresh fetch.
stripRecoveryParam();
