 ...
 *
 * Covers:
 *  - GET /warehouse/columns returns 200 + an array of column descriptors.
 *  - Each entry carries the v2 contract keys.
 *  - The catalog exposes the canonical "label" column from dmWarehouse.
 *  - The catalog excludes the "entity" system field.
 */
class WarehouseColumnsTest extends DolibarrRealTestCase
{
    ...
    public function testCatalogContainsLabelColumn(): void
    {
        ...
        $this->assertArrayHasKey('label', $byKey, 'warehouse catalog must expose the label column');
