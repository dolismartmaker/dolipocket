 ...
 *
 * Covers:
 *  - GET /supplierinvoice/columns returns 200 + an array of column descriptors.
 *  - Each entry carries the v2 contract keys.
 *  - The catalog exposes the canonical "ref" column from dmSupplierInvoice.
 *  - The catalog excludes the "entity" system field.
 */
class SupplierInvoiceColumnsTest extends DolibarrRealTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // hasRight('fournisseur', 'facture', 'lire') checks $conf->modules['fournisseur'].
    ...
    public function testCatalogContainsRefColumn(): void
    {
        ...
        $this->assertArrayHasKey('ref', $byKey, 'supplier invoice catalog must expose the ref column');
